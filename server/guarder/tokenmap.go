...
func createTokenMapWithConfig(conf server.Config, prefix string) (*TokenMap, error) {
	var err error
	v := NewTokenMap()
	if err != nil {
		return nil, err
...
func tokenMapIdentifierFactory(conf server.Config, prefix string) (Identifier, error) {
